...
## [2.5.0](https://github.com/cacack/gedcom-go/compare/v2.4.0...v2.5.0) (2026-08-31)
...
* **gedcom:** add SetPlaceName on Event and Attribute ([1aca8bc](https://github.com/cacack/gedcom-go/commit/1aca8bc649f1874bb5454b89be44fc8645e4bde2)), closes [#483](https://github.com/cacack/gedcom-go/issues/483)
* **gedcom:** mark every symbol v3 removes as deprecated ([de00b1f](https://github.com/cacack/gedcom-go/commit/de00b1f387e8bba555fe6ed1bf12792b4891cb68)), closes [#521](https://github.com/cacack/gedcom-go/issues/521)
* **validator:** add Issue.LineNumber and populate it where the line is known ([dfeac98](https://github.com/cacack/gedcom-go/commit/dfeac98eb81f73f614745576cb6ed9398deb9fdc)), closes [#479](https://github.com/cacack/gedcom-go/issues/479)
...
* **validator:** carry the record's line number where one is known ([1cd85e3](https://github.com/cacack/gedcom-go/commit/1cd85e3651afea7bb1393a459359f6191d14504c)), closes [#498](https://github.com/cacack/gedcom-go/issues/498)
...
* **decoder:** fold SNOTE CONT/CONC continuations into SharedNote.Text ([0355670](https://github.com/cacack/gedcom-go/commit/0355670671c4ad5ab5c7f8382929307849fc8c96))
* **encoder:** encode entity-only Note.Text via a safe textToTags split ([344f2cc](https://github.com/cacack/gedcom-go/commit/344f2cca852c88a95594427582319e47d429323a))
* **encoder:** encode multi-line SharedNote.Text on the entity-only path ([56a08f1](https://github.com/cacack/gedcom-go/commit/56a08f129a9d691ee5ee8f67896fa13a97ad8867))
...
* **build:** set module path to /v2 to make v2 release installable ([e05301b](https://github.com/cacack/gedcom-go/commit/e05301ba9bb8cf33731f289252313b23b223b3c6))
