...
| Field | Value |
|---|---|
| **Canonical Source** | GEDCOM specifications 5.5 / 5.5.1 / 7.0 — see [gedcom-specifications.md](gedcom-specifications.md) |
| **Last Reviewed** | 2025-10-16 |

Lookup reference for GEDCOM date grammars, calendar systems, modifiers, conversion formulas, and edge cases across GEDCOM 5.5, 5.5.1, and 7.0.
Consult it when parsing, validating, or formatting dates.

Sections keep the numbering of the source research report; sections 10 (Best Practices) and 12 (Implementation Recommendations) are omitted here because that implementation guidance is superseded by [ADR-0001](../decisions/0001-custom-date-struct.md) and the shipped code — the full original report is archived at [../archive/gedcom-date-formats-research.md](../archive/gedcom-date-formats-research.md).
