...
- **docs/**: Implementation reference material, organized by type
  ...
  - `reference/` - Lookup material: `gedcom-versions.md`, `gedcom-specifications.md`, `gedcom-date-formats.md`, `gedcom-7-coverage.md` (generated by `make spec-coverage`; do not edit by hand)
