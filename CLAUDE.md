...
- **docs/**: Implementation reference material, organized by type
  ...
  - `reference/` - Lookup material: `gedcom-versions.md`, `gedcom-specifications.md`, `gedcom-date-formats.md`, `gedcom-7-coverage.md` and `gedcom-5.5-coverage.md` (both generated by `make spec-coverage`; do not edit by hand)
  - `guides/` - How-to guides: `converter.md`, `decoding.md`, `migration-v3.md`, `performance.md`, `vendor-extensions.md`
